...
<body>
    <div class="container">
        ...
        <a href="{{ route('profissionais.create') }}" class="btn btn-primary">Criar Novo Profissional</a>
                ...
                @foreach ($profissionais as $profissional)
                    <tr>
                        ...
                        <td class="action-buttons">
                            <a href="{{ route('profissionais.show', $profissional->id) }}" class="btn btn-info">Ver</a>
